...
$tab_mots_vides = file('resources/mots_vides.txt', FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES);
$nbr=0;
...
echo '<h3 style="color:navy">Indexation Reussie</h3>';
echo "<b>Titre du document:</b> ".$title."<br>";
echo "<b>Source: </b>".$source_html."<br><br>";
echo "<b>Descriptif:</b> <br>".$description."<br>";
echo "<h4>Statistiques:</h4>";
echo "<b>Nombre Total des mots dans le document:</b>  ".$nombreMotsTotal."<br>";
echo "<b>Nombre des mots Selectionnes:</b>  ".$nombreMotsSelectionnes."<br>";
echo "<b>Pourcentage des mots Selectionnes:</b>  ".calculPourcentage($nombreMotsTotal, $nombreMotsSelectionnes)." % <br><hr>";
}
